var win = new function () {
    ...
    this.confirm = function (title, message, selected) {
        ...
        var html = '<div class="win"><div class="mask-layer"></div><div class="window-panel"><iframe class="title-panel" frameborder="0" marginheight="0" marginwidth="0" scrolling="no"></iframe><div class="title"><h3 style="color: #333;"></h3></div><a href="javascript:void(0)" onclick="win._close(false);" class="close-btn" title="关闭">×</a><div class="body-panel"><p class="content" style="color: #333;"></p><p class="btns"><button class="w-btn" tabindex="1" onclick="win._close(true);">确定</button><button class="w-btn" onclick="win._close(false);">取消</button></p></div></div></div>';
    ...
    this.alert = function (title, message, closed) {
        ...
        var html = '<div class="win"><div class="mask-layer"></div><div class="window-panel"><iframe class="title-panel" frameborder="0" marginheight="0" marginwidth="0" scrolling="no"></iframe><div class="title"><h3 style="color: #333;"></h3></div><a href="javascript:void(0)" onclick="win._close();" class="close-btn" title="关闭">×</a><div class="body-panel"><p class="content" style="color: #333;"></p><p class="btns"><button class="w-btn" tabindex="1" onclick="win._close();">确定</button></p></div></div></div>';
        messageBox(html, title, message);
    }

};
function alert(title) {
            win.alert('操作提示',title);
        }
function confirm(title) {
    win.confirm('操作提示', title, function (r) {
        if(r) $('.confirm_myfrom_js').click();
