...
(function(host, name, Event, undefined){
	var defConfig = {
		...
		name:'',
		//资源存放目录
		basePath: staticFileContextPath + '/Scripts/static/game/',
		//文件名前缀
	...
	var pros = {
		init:function(cfg){
			...
			me.addEvent('afterSwitchGameMethod', function(){
			    ...
			    //切换后元角选择为元
				var MoneyUnit = $.cookie('MoneyUnit') ? $.cookie('MoneyUnit') : 1;
				Games.getCurrentGameStatistics().setMoneyUnitDom(MoneyUnit);
				//切换后后收起我要追号
