...
(function(host, name, Event, undefined) {
	var defConfig = {
		...
		rowTemplate: '<li data-param="action=reselect&id=<#=id#>" id="gameorder-<#=id#>"><div class="result"><span class="moneyUnitText"><#=moneyUnitText#></span><span class="bet"><#=num#>注</span><span class="multiple"><#=multiple#>倍</span><span class="graduation">模式<#=graduationCountText#></span><span class="price"><span><dfn>&yen;</dfn></span><#=amountText#></span><span class="close"><a data-param="action=del&id=<#=id#>" href="javascript:void(0);" title="删除">删除</a></span></div><span>[<#=typeText#>]</span><span style="position:relative" ><#=lotterysText#></span></li>',
		rowTemplateRx: '<li data-param="action=reselect&id=<#=id#>" id="gameorder-<#=id#>"><div class="result"><span class="moneyUnitText"><#=moneyUnitText#></span><span class="bet"><#=num#>注</span><span class="multiple"><#=multiple#>倍</span><span class="graduation">模式<#=graduationCountText#></span><span class="price"><span><dfn>&yen;</dfn></span><#=amountText#></span><span class="close"><a data-param="action=del&id=<#=id#>" href="javascript:void(0);" title="删除">删除</a></span></div><span>[<#=typeText#>]</span><span  >[<#=selectMediaText#>]</span><span  ><#=lotterysText#></span></li>',
		//显示内容截取字符串长度
	...
	var pros = {
		...
		add: function(order) {
			...
			if (Games.getCurrentGame().getCurrentGameMethod() != null && Games.getCurrentGame().getCurrentGameMethod().defConfig.isRenxuanCheck) {
			    tpl = me.defConfig.rowTemplateRx;
			}
		...
		rebuildData: function(order) {
			...
			order['graduationCountText'] = (order['graduationCount'] * Number(PerGraduation.toFixed(2)) + Number(BasicReward.toFixed(2))).toFixed(0)
			return order;
		},
